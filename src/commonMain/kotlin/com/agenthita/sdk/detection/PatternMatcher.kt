...
enum class HarmCategory {
    ...
    // Self-directed content — unlike every category above, these describe
    // the protected person's OWN unprompted interest/search, not a reply to
    // an attacker. Structurally response-only-shaped already: there is no
    // [CONTACT] side to see for a search query or an unprompted statement.
    ADULT_CONTENT,
    HARMFUL_CONTENT
}
